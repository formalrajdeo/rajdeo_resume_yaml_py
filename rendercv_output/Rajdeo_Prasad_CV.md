...
- Phone: +91 99878 47479
- Email: [formal.rajdeo@gmail.com](mailto:formal.rajdeo@gmail.com)
- Location: Mumbai, India
- Website: [rajdeo.netlify.app](https://rajdeo.netlify.app/)
- LinkedIn: [rajdeo-prasad-a27b49203](https://linkedin.com/in/rajdeo-prasad-a27b49203)
- GitHub: [formalrajdeo](https://github.com/formalrajdeo)
...
**Cloud & DevOps:** AWS (EC2, S3, IAM basics), Docker, CI/CD, Jenkins, Linux Deployment, Nginx

**Tools:** Git, Postman

# Experience
## **Alwrite**, Software Developer
...
Insurance platform for multi-domain insurance products and policy workflows
...
## **Bigiota Analytics**, Software Developer
...
HDFC ERGO digital KYC verification and claims processing system
...
## **Niveus Solutions**, Software Developer
...
ICICI Bank digital onboarding and account opening platform
...
## **EXiTS Group**, Software Developer
...
CRM system and ecommerce platform
...
# Education
## **Mumbai University**, Master of Computer Applications (MCA)
...
## **Mumbai University**, Bachelor of Science in Information Technology (BSc IT)
